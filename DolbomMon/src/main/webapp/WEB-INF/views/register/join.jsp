	...
	<div class="container" >
		<div id="parent" style="cursor:pointer; margin-top:220px; text-align:center;border-radius:20px;">
			<div style="display:inline-block;width:70%;">
				...
				<div style="width:200px;font-size:20px;margin-top:10px;padding:10px;">아이를 돌봐줄 돌봄몬이 필요해요</div>
				<div style="width:200px;font-size:20px;padding:10px;color:rgb(104,189,167); font-weight:bold;">부모회원 가입</div>
			</div>
		</div>
		<div id="dbm" style="cursor:pointer; margin-top:50px; text-align:center;border-radius:20px;">
			<div style="display:inline-block;width:70%;">
				...
				<div style="width:200px;font-size:20px;margin-top:10px;padding:10px;">아이를 돌볼 돌봄몬으로 활동하고 싶어요.</div>
				<div style="width:200px;font-size:20px;padding:10px;color:rgb(243,127,87);font-weight:bold;">돌봄몬회원 가입</div>
			</div>
		</div>
	</div>
