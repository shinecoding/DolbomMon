...
<style>
	...
	input[type=submit]{width:50%; height:40px; margin-bottom:130px;margin-top:20px; }
</style>
<script>
	$(function(){
...
<div class="container">
	<div id="title">
	   	<div id="titlefont">활동가능지역을 입력해주세요</div>
	 </div>
	<form method="post" action="<%=request.getContextPath()%>/dbm/schedule" id="locationFrm" >
...
<script>
    var mapContainer = document.getElementById('map'), // 지도를 표시할 div
        mapOption = {
            center: new daum.maps.LatLng(37.5668196971845,126.97864943034479), // 지도의 중심좌표
            level: 5 // 지도의 확대 레벨
        };
    ...
    markerPosition = new kakao.maps.LatLng(37.5668196971845,126.97864943034479); // 마커가 표시될 위치입니다

    //마커를 미리 생성
    var marker = new daum.maps.Marker({
        position: new daum.maps.LatLng(37.5668196971845,126.97864943034479),
