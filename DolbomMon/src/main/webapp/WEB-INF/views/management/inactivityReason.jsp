...
<body>
	<div class="mainP" style="width:450px; margin:0 auto;">
		<form method="post" name="memoForm" id="memoFrom" action="/dbmon/reasonInsert">
			<input type="hidden" name="no" value="${no }"/>
			<textarea name="memo" class="form-control" style="width:100%; height:300px;" placeholder="회원 정지 사유입니다.">${reason}</textarea>
			<input type="submit" id="sub" value="정지 사유 등록" class="btn btn-info" style="width:100%">
		</form>
	</div>
</body>
</html>