 ...
 <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
 	<div class="container">
		...
		<div class="form-group" id="divId">
		    ...
		    <div class="col-lg-12">
		        <input type="text" class="form-control onlyAlphabetAndNumber" id="id" data-rule-required="true" placeholder="관리자 아이디" maxlength="30">
		    </div>
		</div>
		...
		<div class="form-group" id="divName">
		    ...
		    <div class="col-lg-12">
		        <input type="text" class="form-control onlyHangul" id="name" data-rule-required="true" placeholder="이름" maxlength="15">
		    </div>
		</div>
