	...
	$(function(){
		...
		$(document).ready(function(){
			...
			if(getTime_type=="R"){
				...
				//////////////////////////////sdVO
//////////////////////sd //////////////////////
				var getSeleted_date = "${sdVO.select_date}";
				var selectedDate = getSeleted_date.split(", ");
...
<script>
	...
	$("#writeFrm").submit(function(){
	    ...
	    frm.action = http://www.abc.com/requestPage.asp;
	    frm.target="winName";
	    frm.submit();
	})
	  */  
...
<body>
	<div class="container" style="font-family: 'Poor Story', cursive !important;">
		<form id="writeFrm" method="post" action="contractWrite">
			<input type="hidden" name="origin_no" value="${no }" />
			<div id="header" style="width:150px; height:150px;">
				<a href="#"><img src="<%=request.getContextPath()%>/img/mylogo.png"/></a>
			</div>
			...
			<div id="submitDiv" >
				<input class="btn btn-warning" type="submit" value="계약서 보내기" />
			</div>
