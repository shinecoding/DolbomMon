...
<body>
	...
	<div class="container">
		...
		선호하는 유형을 선택해주세요
			...
			<div id="typeHidden">
				<input type="radio" name="tType" id="typeOne" />
				<input type="radio" name="tType" id="typeTwo" />
				<input type="radio" name="tType" id="typeThree" />
				<input type="radio" name="tType" id="typeFour" />
				<input type="radio" name="tType" id="typeFour" />
				
			</div>
			<label for="typeOne"><b>신생아/영아 풀타임 돌봄</b><br/>
						- 0~24개월 아이를 먹이고, 재우고, 놀아주는 활동<br/>
						- 보통 주5일 하루 8~10시간 책임지고 돌봄 필요<br/>
						- 아이 관련 가사활동 필수<br/></label>
			<label for="typeTwo"><b>등하원 돌봄</b>
						- 2~10세 아이를 기관에 가기 전후에 돌보는 활동<br/>
						- 보통 주5일 하루 3~5시간 책임지고 돌봄 필요<br/>
						- 등하원, 밥 챙겨주기, 씻기기, 놀아주기 활동 포함<br/></label>
			<label for="typeThree"><b>신생아/영아 보조 돌봄</b><br/>
						- 0~24개월 아이를 보호자와 함께 또는 혼자 돌봄<br/>
						- 최근 0~12개월 돌본 경험 1주일 이상 필수<br/>
						- 주 1~4회 정기적으로 또는 단기로 2~4시간 활동<br/></label>
			<label for="typeFour"><b>놀이/학습 돌봄</b><br/>
						- 2~10세 아이와 특기를 활용해서 즐겁고 학습적인 시간을 보내는 활동<br/>
						- 주 1~4회 정기적으로 또는 단기로 2~4시간 활동<br/></label>
			<label for="typeFive"><b>긴급/단기 돌봄</b><br/>
